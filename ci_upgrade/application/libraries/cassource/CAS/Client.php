    ...
    */
    ...
    public function getServerLoginURL($gateway=false,$renew=false)
    {
        ...
        if ( empty($this->_server['login_url']) ) {
            ...
            /*
             * Seeing if replacing localhost here to cs-course-evals.ewu.edu makes it work for localhost
            */
            $this->_server['login_url'] = str_replace('localhost', 'cs-course-evals.ewu.edu', $this->_server['login_url']);
        }
